...
function YFormSendMail() {
  return (
    <div
      id="FormSendMail"
      className="w-full h-full flex flex-col justify-center p-4 gap-6 md:flex-row-reverse md:items-center md:h-full md:justify-evenly md:py-16 md:px-8 md:gap-16"
    >
      <div className="md:w-1/3 bg-secondary py-8 px-8">
      ...
      <div className="md:w-1/2 md:h-[85vh]">
        <CardInfoImg
        ...
        >
          ...
          <ol type="1" className="text-justify">
            ...
            <li>
              2. Un asesor se pondrá en contacto contigo para agendar una cita.
            </li>
